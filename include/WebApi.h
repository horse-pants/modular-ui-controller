 ...
 * global managers (g_ledManager / g_uiManager), NVS, and the embedded web
 * assets (WebAssets.h) — so they live
...
/// Register /test, the LED-config + settings REST API, and the embedded SPA.
